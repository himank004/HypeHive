...
export const recommendProducts = async (req, res) => {
  try {
    ...
    const response = await hf.textClassification({
      ...
      parameters: {
        candidate_labels: inputs.labels.join(','),
      },
    });
...
export const createProduct = async (req, res) => {
  try {
    const { name, description, price, image, category, containsDifferentSizes, sizes } = req.body;
    ...
    const product = await Product.create({
      ...
      category,
      containsDifferentSizes,
      sizes: containsDifferentSizes ? sizes : []
    });
